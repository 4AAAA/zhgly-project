			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="customer/billList.do" method="post" name="Form" id="Form">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
								    ...
								    <th class="center">欠费金额</th> 
								    <th class="center">维修成本</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'><b class="purple">¥&nbsp;${var.MONEY}</b></td> 									
											<td class='center'><b class="blue">¥&nbsp;${var.INCOME}</b></td> 
