			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="orderbook/list.do" method="post" name="Form" id="Form">
...
<%-- 									<c:if test="${QX.add == 1 }">
	...
	<script type="text/javascript">
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增记事本";
			 diag.URL = '<%=basePath%>orderbook/goAdd.do';
			 diag.Width = 450;
			 diag.Height = 400;
		...
		function del(Id){
			bootbox.confirm("确定要删除吗?", function(result) {
				if(result) {
					top.jzts();
					var url = "<%=basePath%>orderbook/delete.do?GOODS_ID="+Id+"&tm="+new Date().getTime();
		...
		function edit(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>orderbook/goEdit.do?GOODS_ID='+Id;
			 diag.Width = 450;
			 diag.Height = 400;
			 diag.Modal = true;				//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮
