...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="outku/salesReport.do" method="post" name="Form" id="Form">
						<input name="forderby" id="forderby" value="" type="hidden" />
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="vertical-align:top;padding-left:2px;">
									...
									<option value="90" <c:if test="${'90' == pd.days }">selected</c:if>>90天内</option>
								  	</select>
								</td>
								<c:if test="${QX.cha == 1 }">
	...
	<script type="text/javascript">
		...
		//排序
		var zj = 'order by ZPRICE';
		var xl = 'order by ZCOUNT';
		function orderby(msg){
			var value= "${pd.forderby }";
			if('zj' == msg){
				if(value== zj){
					zj = 'order by ZPRICE desc';
				}else{
					zj = 'order by ZPRICE';
				}
				$("#forderby").val(zj);
