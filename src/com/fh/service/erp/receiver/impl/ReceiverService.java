package com.fh.service.erp.receiver.impl;
...
public class ReceiverService implements ReceiverManager{
	...
	public void save(PageData pd)throws Exception{
		dao.save("ReceiverMapper.save", pd);
	}
	...
	public void delete(PageData pd)throws Exception{
		dao.delete("ReceiverMapper.delete", pd);
	}
